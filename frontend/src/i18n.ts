...
export const catalog = {
  zh: {
    ...
    'today.eyebrow': '今天的一小步',
    'today.heading': '今日任务',
    'today.minutes': '{n} 分钟',
    'today.lesson': '开始课时',
    'today.practice': '继续练习',
    'today.review': '开始复习',
    'today.reason.resume': '从上次卡住的地方继续，先解决一个小问题。',
    'today.reason.start': '开始一个小目标，建立今天的学习节奏。',
    'today.reason.review': '把较早学过的知识点再调用一次，让它留下来。',
    'stats.progress': '课程进度',
    ...
    'practice.feedback.title': '学习反馈',
    'practice.feedback.allPassed': '全部通过。先回想一下你解决这道题的关键步骤，再继续下一道。',
    'practice.feedback.wrongOutput': '代码运行了，但结果和预期不同。先对照样例检查返回值、条件和边界。',
    'practice.feedback.runtimeError': '代码在运行时遇到了问题。先看错误信息指向的那一行，再检查输入类型和执行顺序。',
    'practice.feedback.validationError': '先让函数契约通过：检查函数名、参数顺序和返回结构，再继续调试逻辑。',
    'practice.feedback.hints': '分层提示',
    'practice.feedback.showHint': '查看第 {n} 层提示',
    'practice.feedback.nextStep': '下一步',
    'practice.feedback.review': '把这个思路带到下一道题',
    'auth.welcome': '欢迎回来',
    'auth.start': '启程',
  ...
  en: {
    ...
    'today.eyebrow': 'ONE SMALL STEP',
    'today.heading': "Today's task",
    'today.minutes': '{n} min',
    'today.lesson': 'Start lesson',
    'today.practice': 'Continue practice',
    'today.review': 'Review now',
    'today.reason.resume': 'Pick up where you got stuck and solve one small problem.',
    'today.reason.start': 'Choose one small goal and build today’s learning rhythm.',
    'today.reason.review': 'Recall an older concept once more so it can stick.',
    ...
    'practice.feedback.title': 'Learning feedback',
    'practice.feedback.allPassed': 'All passed. Take a moment to recall the key idea before moving on.',
    'practice.feedback.wrongOutput': 'The code ran, but the result differs from the expected output. Check the return value, conditions, and boundaries.',
    'practice.feedback.runtimeError': 'The code hit a runtime problem. Start with the line in the error, then check input types and execution order.',
    'practice.feedback.validationError': 'Make the function contract pass first: check the name, parameter order, and return shape before debugging the logic.',
    'practice.feedback.hints': 'Layered hints',
    'practice.feedback.showHint': 'Show hint {n}',
    'practice.feedback.nextStep': 'Next step',
    'practice.feedback.review': 'Carry this idea into another problem',
